        ...
        <div className="pb-20  pt-24 csm:mt-14 csm:mb-4 p-12 csm:p-8">
          ...
          <div className="flex csm:block gap-52 cxl:gap-40 clg:gap-20 cmd:gap-10 justify-center mt-16">
            ...
            <div className="csm:mb-20">
              ...
              <a href="https://omnifood-rizki.netlify.app" className="mb-8 uppercase block text-white bg-teal-500 py-2 px-4 rounded-md hover:bg-teal-400 font-semibold text-center">
                LIVE DEMO
              </a>
            </div>
            <div>
              ...
              <a href="https://natours-rizki.netlify.app/" className="mb-8 uppercase block text-white bg-teal-500 py-2 px-4 rounded-md hover:bg-teal-400 font-semibold text-center">
                LIVE DEMO
              </a>
            </div>
          </div>
